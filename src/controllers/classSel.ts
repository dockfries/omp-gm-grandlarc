...
const setupSelectedCity = (p: Player) => {
  ...
  switch (s.selectedCity) {
    case CityEnum.LOS_SANTOS:
      ...
      p.setCameraLookAt(1887.6034, -1682.1442, 47.6167, CameraCutStylesEnum.CUT);
      losSantosTD.show(p);
      break;
    case CityEnum.SAN_FIERRO:
      p.setCameraPos(-1300.8754, 68.0546, 129.4823);
      p.setCameraLookAt(-1817.9412, 769.3878, 132.6589, CameraCutStylesEnum.CUT);
      sanFierroTD.show(p);
      break;
  ...
  setupCharSelection(p: Player) {
    ...
    switch (selectedCity) {
      ...
      case CityEnum.SAN_FIERRO:
        ...
        p.setCameraLookAt(-2673.8381, 1399.7424, 918.3516, CameraCutStylesEnum.CUT);
        break;
      default:
        p.setInterior(3);
